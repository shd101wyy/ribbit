// Referred from: https://github.com/saurfang/ipfs-multihash-on-solidity/blob/master/src/multihash.js
 ...
 * @returns {Multihash}
 */
export function getBytes32FromMultiash(
  multihash: string
): { digest: string; hashFunction: number; size: number } {
...
export function getMultihashFromBytes32(multihash: {
  ...
  const multihashBytes = new (hashBytes.constructor as any)(
    2 + hashBytes.length
  );
