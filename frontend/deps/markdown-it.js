      ...
      18: [
        function(e, r, t) {
          ...
          r.exports = function(e, r, t, s) {
            ...
            if (s) return !0;
            for (
              c = f = e.sCount[r] + D - (e.bMarks[r] + e.tShift[r]),
            ...
            for (
              ...
              if (62 !== e.src.charCodeAt(D++) || A) {
                ...
                for (
                  c = f = e.sCount[h] + D - (e.bMarks[h] + e.tShift[h]),
                    32 === e.src.charCodeAt(D)
                      ? (D++, c++, f++, (o = !1), (v = !0))
                      : 9 === e.src.charCodeAt(D)
                        ? ((v = !0),
          ...
          r.exports = function(e, r, t, i) {
            ...
            for (
              ...
              for (
                E = S,
                  v = e.eMarks[x],
                  h = y = e.sCount[x] + S - (e.bMarks[r] + e.tShift[r]);
                E < v;
      ...
      27: [
        function(e, r, t) {
          ...
          r.exports = function(e, r, t, o) {
            ...
            for (
              A = (b = e.getLines(r, w, e.blkIndent, !1).trim()).length, C = 1;
              C < A;
              C++
            ) {
              ...
              (!!(f = n(b.slice(1, d))) &&
                (!!o ||
                  ...
                  void 0 === e.env.references[f] &&
                    (e.env.references[f] = { title: x, href: u }),
                  (e.parentType = m),
                  (e.line = r + y + 1),
                  !0)))
            );
            ...
            if (e.md.options.linkify)
              for (t = 0, i = x.length; t < i; t++)
                if (
                  ...
                  for (_ = 0, r = (a = x[t].children).length - 1; r >= 0; r--)
                        ...
                        for (
                          ...
                          (g = v[p].url),
                            ...
                            e.md.validateLink(b) &&
                              ...
                              (d = v[p].lastIndex));
                        d < h.length &&
                          (((c = new e.Token("text", "", 0)).content = h.slice(
                            d
                          )),
                          (c.level = m),
                          u.push(c)),
        ...
        function(e, r, t) {
          ...
          function s(e) {
            ...
            for (r = e.length - 1; r >= 0; r--)
              "text" !== (t = e[r]).type ||
                s ||
                (t.content = t.content.replace(c, n)),
                    ...
                    !e.md.validateLink(c) ||
                      (r ||
                        ...
                        ((l = e.push(
                          ...
                          "",
                          0
                        )).content = e.md.normalizeLinkText(a)),
          ...
          r.exports = function(e, r) {
            ...
            for (
              ...
              if (i - o === s.length)
                return (
                  r ||
                    (((a = e.push("code_inline", "code", 0)).markup = s),
                    (a.content = e.src
                      .slice(c, o)
                      .replace(/[ \n]+/g, " ")
                      .trim())),
          ...
          r.exports = function(e, r) {
            ...
            if (u + 1 < p)
              if (35 === e.src.charCodeAt(u + 1)) {
                ...
                return r || (e.pending += n[l[1]]), (e.pos += l[0].length), !0;
        ...
        function(e, r, t) {
          ...
          r.exports = function(e, r) {
            ...
            if ((l = a + 1) < m && 40 === e.src.charCodeAt(l)) {
              for (
                g = !1, l++;
                l < m && ((o = e.src.charCodeAt(l)), s(o) || 10 === o);
                l++
              );
              if (l >= m) return !1;
              for (
        ...
        function(e, r, t) {
          ...
          (n.prototype.parse = function(e, r) {
            ...
            if (((l = l.trim()), !r && 1 === e.split("#").length)) {
              ...
              if (_)
                return (
                  (this.pathname = _[1]), _[2] && (this.search = _[2]), this
                );
            }
            var g = s.exec(l);
            if (
              ...
              for (
                -1 !==
                  (v = -1 === b ? l.lastIndexOf("@") : l.lastIndexOf("@", b)) &&
                  ((k = l.slice(0, v)), (l = l.slice(v + 1)), (this.auth = k)),
                  b = -1,
                  t = 0;
                t < u.length;
                t++
            ...
            var z = l.indexOf("?");
            return (
              -1 !== z && ((this.search = l.substr(z)), (l = l.slice(0, z))),
              l && (this.pathname = l),
            ...
            !(function(n) {
              ...
              function h(e) {
                var r,
                  ...
                  b = D,
                  C = w;
                for ((t = e.lastIndexOf(q)) < 0 && (t = 0), n = 0; n < t; ++n)
                ...
                for (o = t > 0 ? t + 1 : 0; o < _; ) {
                  for (
                    i = g, a = 1, u = v;
                    o >= _ && s("invalid-input"),
                      ((h = l(e.charCodeAt(o++))) >= v || h > T((k - g) / a)) &&
                        s("overflow"),
                      (g += h * a),
                      (f = u <= C ? x : u >= C + y ? y : u - C),
                      !(h < f);
              ...
              function f(e) {
                var r,
                  ...
                  A = [];
                for (
                  _ = (e = a(e)).length, r = D, t = 0, i = w, c = 0;
                  c < _;
                  ++c
                )
                  (m = e[c]) < 128 && A.push(I(m));
                for (n = o = A.length, o && A.push(q); n < _; ) {
                  for (l = k, c = 0; c < _; ++c)
                    (m = e[c]) >= r && m < l && (l = m);
                  for (
                    l - r > T((k - t) / (g = n + 1)) && s("overflow"),
                      t += (l - r) * g,
                      r = l,
                      c = 0;
                    c < _;
                    ...
                    if (((m = e[c]) < r && ++t > k && s("overflow"), m == r)) {
                      for (
                        h = t, f = v;
                        (d = f <= i ? x : f >= i + y ? y : f - i), !(h < d);
                        f += v
                      )
                        (C = h - d),
                          (b = v - d),
                          A.push(I(u(d + C % b, 0))),
                          (h = T(C / b));
                      A.push(I(u(h, 0))), (i = p(t, g, n == o)), (t = 0), ++n;
                    }
                  ++t, ++r;
                }
                return A.join("");
